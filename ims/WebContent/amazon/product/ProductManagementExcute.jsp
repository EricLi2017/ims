...
<%
    ...
    if (isQuery) {
        ...
        productAndOrders = new QueryProductAndOrder().querySkuSalesSum(Time.getTimeInPST(createdAfter), Time.getTimeInPST(createdBefore), sku, asin, fnsku, name, orderBy, ascOrDesc);
    }
%>