...
<%
	...
	if (isQuery) {
		...
		int previousRows = ListOrderAndOrderItemsManager
				.getCountWithOrderItemsByPurchaseDateFromDB(createdAfter, createdBefore);
		...
		int totalRows = ListOrderAndOrderItemsManager.getCountWithOrderItemsByPurchaseDateFromDB(createdAfter,
				createdBefore);

		//query database to get the total orders without order items
		int totalRowsWithout = ListOrderAndOrderItemsManager
				.getCountWithoutOrderItemsByPurchaseDateFromMWS(createdAfter, createdBefore);
