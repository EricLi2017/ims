...
public class SKUMatch {
    ...
    /**
     * get sku count where sku exists in order_items but not exists in amazon_product
     *
     * @return
     */
...
//        System.out.println("There are " + new SKUMatch().getSkuCountFromProducts() + " sku in product records.");
//        System.out.println("There are " + new SKUMatch().getAsinCountFromProducts() + " asin in product records.");
//        System.out.println("There are " + new SKUMatch().getSkuCountFromOrders() + " sku in order records.");
//        System.out.println("There are " + new SKUMatch().getAsinCountFromOrders() + " asin in order records.");
//        System.out.println("There are " + new SKUMatch().getSkuCountNotInProducts() + " sku that exists in order records but not exists in product records.");
//        System.out.println(new SKUMatch().getSkuNotInProducts() + "are the sku that exists in order records but not exists in product records.");
    }
