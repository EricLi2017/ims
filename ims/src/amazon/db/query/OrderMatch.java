...
/**
 * Check if orders and order items are matched in database of IMS Created by
 * Eric Li on 3/3/2017.
 */
public class OrderMatch {

	/**
	 * check ims sum: count() in orders,sum(sku units) in orders,sum(sku units) in
	 * order_items
	 *
	 * @return OrderMatchResult
	 */
	public OrderMatchResult check(XMLGregorianCalendar createdAfter, XMLGregorianCalendar createdBefore) {
	...
	public class OrderMatchResult {
		...
		public String toString() {
			return "OrderMatchResult{" + "orderNum=" + orderNum + ", itemNum=" + itemNum + ", orderNum2=" + orderNum2
					+ ", itemNum2=" + itemNum2 + '}';
		}
	}
