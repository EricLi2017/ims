...
public class ListOrderAndOrderItemsManager {
     ...
     */
    public static List<SkuSum> getSumByPruchaseDate(XMLGregorianCalendar createdAfter, XMLGregorianCalendar createdBefore) {
    ...
    /**
     * query database, call MWS to get amazon order items and insert into
     * database
     */
     ...
     * 1. call MWS to get batch orders
     * 2.1. call MWS to get order items of this order
     * 2.2. insert order items into database
     * 2.3. insert order into database
     * 2.4. go to 2.1 for loop until batch orders end
     * 3. call MWS to get other orders
     * 4. go to 2.1 for loop until batch orders end
     *
    ...
    private InsertResult insertOrderAndOrderItemsFromMWS(Order order) {
     ...
     */
    private List<InsertResult> insertOrderAndOrderItemsFromMWS(List<Order> orders) {
        ...
        for (Order order : orders) {
            ...
            if (insertResult != null) insertResults.add(insertResult);
        }
        return insertResults;
    }
    ...
    public class InsertResult {
        ...
        public String toString() {
            return "InsertResult{" +
                    ...
                    ", insertOrderSuccess=" + insertOrderSuccess +
                    ", insertOrderItemsSuccess=" + insertOrderItemsSuccess +
                    '}';
        }
    }
