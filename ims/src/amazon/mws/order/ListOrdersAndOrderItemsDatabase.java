...
public class ListOrdersAndOrderItemsDatabase {
	...
	public List<SkuSum> selectSumByPruchaseDate(Timestamp createdAfter, Timestamp createdBefore) {
		...
		// select b.sku as
		// sku,sum(if(a.is_business_order='false',b.price_amount-b.discount_amount,null)
		// ) as sales,
		// sum(if(a.is_business_order='true',b.price_amount-b.discount_amount,null) ) as
		// sales_b2b,sum(if(a.is_business_order='false',b.quantity_ordered,null)) as
		// ordered, sum(if(a.is_business_order='true',b.quantity_ordered,null)) as
		// ordered_b2b from orders as a, order_items as b where
	...
	public int selectCountWithOrderItemsByPruchaseDate(Timestamp createdAfter, Timestamp createdBefore) {
		...
		// String sql = "select count(a.amazon_order_id) from orders as a, order_items
		// as b where a.amazon_order_id=b.amazon_order_id and a.purchase_date>=? and
		// a.purchase_date<?";
